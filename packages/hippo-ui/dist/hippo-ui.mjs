import { createVNode as createVNode$1 } from "vue";
...
const HButton = defineComponent({
  ...
  setup(props2, {
    ...
    font-semibold
    shadow-md
    ${props2.rounded ? "rounded-full" : "rounded-lg"}
    text-${size2[props2.size].text}
    text-${props2.plain ? props2.color + "-500" : "white"}
    bg-${props2.color}-${props2.plain ? "300" : "500"}
    hover:bg-${props2.color}-${props2.plain ? "400" : "700"}
